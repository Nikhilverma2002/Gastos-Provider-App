...
public final class ActivityAboutUsBinding implements ViewBinding {
  ...
  private ActivityAboutUsBinding(@NonNull ConstraintLayout rootView, @NonNull TextView about,
      @NonNull TextView aboutUsText, @NonNull ImageView prev) {
  ...
  public static ActivityAboutUsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAboutUsBinding((ConstraintLayout) rootView, about, aboutUsText, prev);
    }
