...
public final class AboutUsBinding implements ViewBinding {
  ...
  private AboutUsBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imageView,
  ...
  public static AboutUsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new AboutUsBinding((ConstraintLayout) rootView, imageView, textView3, textView4);
    }
