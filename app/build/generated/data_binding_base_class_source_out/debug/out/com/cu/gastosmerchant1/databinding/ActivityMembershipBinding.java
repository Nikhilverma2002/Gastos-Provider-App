...
public final class ActivityMembershipBinding implements ViewBinding {
  ...
  private ActivityMembershipBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView check,
  ...
  public static ActivityMembershipBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMembershipBinding((ConstraintLayout) rootView, check, check1, cons1,
