...
public final class BillPaymentBinding implements ViewBinding {
  @NonNull
  ...
  private BillPaymentBinding(@NonNull ConstraintLayout rootView, @NonNull ConstraintLayout cons1,
      @NonNull View divider2, @NonNull TextView grandTotal, @NonNull TextView grandTxt,
      @NonNull TextView gst, @NonNull ImageView imageView12, @NonNull TextView proceedPay,
  ...
  @NonNull
  public static BillPaymentBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static BillPaymentBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.bill_payment, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static BillPaymentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new BillPaymentBinding((ConstraintLayout) rootView, cons1, divider2, grandTotal,
          grandTxt, gst, imageView12, proceedPay, scrollView3, serviceCharge, textView14,
          textView21, textView29, textView30, textView31);
    }
