...
public final class ActivityBillPaymentBinding implements ViewBinding {
  ...
  private ActivityBillPaymentBinding(@NonNull ConstraintLayout rootView,
      @NonNull ConstraintLayout cons1, @NonNull View divider2, @NonNull TextView grandTotal,
      @NonNull TextView grandTxt, @NonNull TextView gst, @NonNull ImageView imageView12,
      @NonNull TextView proceedPay, @NonNull ScrollView scrollView3,
  ...
  @NonNull
  public static ActivityBillPaymentBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityBillPaymentBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_bill_payment, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityBillPaymentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityBillPaymentBinding((ConstraintLayout) rootView, cons1, divider2,
          grandTotal, grandTxt, gst, imageView12, proceedPay, scrollView3, serviceCharge,
          textView14, textView21, textView29, textView30, textView31);
    }
