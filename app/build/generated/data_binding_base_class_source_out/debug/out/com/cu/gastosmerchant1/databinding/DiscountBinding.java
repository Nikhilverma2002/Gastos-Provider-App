...
public final class DiscountBinding implements ViewBinding {
  ...
  private DiscountBinding(@NonNull ConstraintLayout rootView, @NonNull TextView bharatpay,
  ...
  @NonNull
  public static DiscountBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static DiscountBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.discount, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DiscountBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DiscountBinding((ConstraintLayout) rootView, bharatpay, imageView, imageView2,
